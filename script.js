document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.tagName === 'TEXTAREA' && field.hasAttribute('required') && value.length < 10) {
        showError(field, fieldLabel + ' must be at least 10 characters.');
        return false;
      }
  ...
  const SELECTOR = '.animate-on-scroll, [data-animate], .feature-card, .section-header, .hero-content, .testimonial-card, .pricing-card, .team-member, .gallery-item, .blog-card, .service-card, .cta-section, .about-content, .contact-wrapper';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b3ecb810-6fd1-4821-bad4-3d16488ec139',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b3ecb810-6fd1-4821-bad4-3d16488ec139';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b3ecb810-6fd1-4821-bad4-3d16488ec139';
